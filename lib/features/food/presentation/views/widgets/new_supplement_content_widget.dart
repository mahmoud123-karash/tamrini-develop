...
class NewSupplementContentWidget extends StatelessWidget {
  const NewSupplementContentWidget({
    super.key,
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              addTextField(
                lable: S.of(context).supplement_name,
              ...
              addTextField(
                lable: S.of(context).supplemment_description,
