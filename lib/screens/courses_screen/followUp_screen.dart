                ...
                child: Column(
                  children: [
                    ...
                    _.traineeData?.followUpList == null ||
                            _.traineeData?.followUpList!.length == 0
                        ? const Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(children: [
                                        Text(
                                            'ملاحظة بتاريخ ${DateFormat('yyyy-MM-dd').format(DateTime.parse(_.traineeData?.followUpList![index].createdAt!.toDate().toString() ?? ''))}'),
                                      ]),
                                    ),
                                  ),
                                ),
