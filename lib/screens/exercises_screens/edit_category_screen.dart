...
class EditEXECategoryScreen extends StatefulWidget {
  final Exercise category;

  const EditEXECategoryScreen({Key? key, required this.category})
      : super(key: key);

  @override
  State<EditEXECategoryScreen> createState() => _EditEXECategoryScreenState();
}

class _EditEXECategoryScreenState extends State<EditEXECategoryScreen> {
  String? oldTitle;
