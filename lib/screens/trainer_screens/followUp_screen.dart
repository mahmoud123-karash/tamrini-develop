                ...
                child: Column(
                  children: [
                    ...
                    _.selectedTrainee?.followUpList == null ||
                            _.selectedTrainee?.followUpList!.length == 0
                        ? const Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(children: [
                                        Text(
                                            'ملاحظة بتاريخ ${DateFormat('yyyy-MM-dd').format(DateTime.parse(_.selectedTrainee?.followUpList![index].createdAt!.toDate().toString() ?? ''))}'),
                                      ]),
                                    ),
                                  ),
                                ),
