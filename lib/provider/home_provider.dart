...
class HomeProvider extends ChangeNotifier {
  ...
  List<Gym> gyms = [];
  List<exer.Data> exercises = [], _exercises = [];
  ...
  init(
      ...
      required ExerciseProvider exerciseProvider}) async {
  ...
  addBanner(Map<String, String> banner) async {
    ...
    await Dio().put(
      ...
      if (value.statusCode == 200) {
        Fluttertoast.showToast(msg: "تم اضافة البانر بنجاح");
  ...
  deleteBanner({required Map<String, dynamic> banner}) async {
    ...
    await Dio().put(
      ...
      if (value.statusCode == 200) {
        Fluttertoast.showToast(msg: "تم حذف البانر بنجاح");
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        AwesomeDialog(
          ...
          title: "هل انت متأكد؟",
          desc: "${"سيتم حظر المستخدم " + data['name']} من التطبيق",
          btnOkOnPress: () {
            ...
            AwesomeDialog(
              ...
              desc: "${"تم حظر المستخدم " + data['name']} من التطبيق",
              btnOkOnPress: () {
                pop();
                pop();
              },
