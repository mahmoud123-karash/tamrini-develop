...
class ExerciseProvider extends ChangeNotifier {
  ...
  List<Data> selectedExercise = [];
  List<Data> selectedSuperSetExercise = [];
  ...
  Future<void> addExercise(
    ...
    try {
      ...
      AwesomeDialog(
        ...
        animType: AnimType.BOTTOMSLIDE,
        title: 'حدث خطأ',
        desc: 'حدث خطأ اثناء اضافة التمرين',
        btnOkOnPress: () {
          pop();
        },
      ).show();
  ...
  Future<void> deleteExercise(
      {required Data exercise, required Exercise category}) async {
    try {
      //TODO: show loading
  ...
  Future<void> editCategory({
    ...
    try {
      ...
      AwesomeDialog(
        ...
        animType: AnimType.BOTTOMSLIDE,
        title: 'حدث خطأ',
        desc: 'حدث خطأ اثناء تعديل القسم',
        btnOkOnPress: () {},
      ).show();
    }
  }
