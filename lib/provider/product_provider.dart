  ...
  addPaymentMethod(Payment payment) async {
    try {
      ...
      AwesomeDialog(
        ...
        desc: 'تمت إضافة طريقة دفع جديدة',
        btnOkOnPress: () {},
      ).show();
      ...
      AwesomeDialog(
        ...
        animType: AnimType.BOTTOMSLIDE,
        title: 'حدث خطأ',
        desc: 'حدث خطأ أثناء إضافة طريقة دفع جديدة',
        btnOkOnPress: () {},
      ).show();
      print(error);
    }
  ...
  deletePaymentMethod(Payment payment) async {
    try {
      ...
      AwesomeDialog(
        ...
        animType: AnimType.bottomSlide,
        title: 'حدث خطأ',
        desc: 'حدث خطأ أثناء إزالة طريقة دفع',
        btnOkOnPress: () {},
      ).show();
      print(error);
    }
      ...
      await Dio().put(
        ...
        if (value.statusCode == 200) {
          ...
          AwesomeDialog(
            ...
            animType: AnimType.bottomSlide,
            title: 'حدث خطأ',
            desc: 'حدث خطأ أثناء تعديل طريقة دفع',
            btnOkOnPress: () {},
          ).show();
        }
      });
  ...
  Future<void> addCategory(
    ...
    try {
      ...
      AwesomeDialog(
        ...
        animType: AnimType.BOTTOMSLIDE,
        title: 'حدث خطأ',
        desc: 'حدث خطأ أثناء إضافة قسم جديد',
        btnOkOnPress: () {},
      ).show();
    }
  }
